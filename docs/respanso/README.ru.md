...
- [Архитектура сборки и CI/CD](BUILD-CI.md)
- [Устойчивость Astra Linux / X11](ASTRA-X11-STABILITY.md)
- [AI/MCP](AI-MCP.md)

Сборочные документы объясняют не только команды, но и гарантии релизного
контура: зафиксированный Rust, ABI glibc 2.28 для Astra, стратегию кэширования,
release gates и правила неизменности pre-stable/stable веток.
