...
fn worker_main(args: CliModuleArgs) -> i32 {
    ...
    // Restore the hardened Astra runtime used by the known-good X11 build.
    // This is deliberately before tray/detector/injector/clipboard Xlib use,
    // and also restores runtime/x11-native.log for workstation diagnostics.
